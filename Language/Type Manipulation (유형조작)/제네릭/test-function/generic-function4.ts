type UnionType = number | string | boolean | Array<string>

function expressTypeAboutInput1<T extends UnionType>(variable: T): UnionType {
    return typeof variable;
}
console.log(expressTypeAboutInput1<number>(1000)); // 매개변수의 제네릭타입을 명시 O
console.log(expressTypeAboutInput1(2000)); // 매개변수의 제네릭타입 명시 X
console.log(expressTypeAboutInput1<boolean>(true));
 ...
 * @param variable
 */
function expressTypeAboutInput2<T extends UnionType>(variable: T): string {
    return typeof variable;
}
console.log(expressTypeAboutInput2<number>(1000));
console.log(expressTypeAboutInput2(2000));
console.log(expressTypeAboutInput2<Array<string>>([ 'one', 'two', 'three' ]));
